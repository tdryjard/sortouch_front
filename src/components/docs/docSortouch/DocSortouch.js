        ...
        <title>Sortouch : comment utiliser sortouch</title>
            ...
            <div className="contentDoc">
                ...
                <div className="contentDocSortouch">
                    ...
                    {window.innerWidth > 1280 && <p className="numberStepDoc">4</p>}
                    <div className="onContentDoc">
                        <p className="textDocSortouch">Intégrer son chatbot à son site wordpress <Link style={{color: "rgb(46, 46, 46)"}} to="/installer-wordpress">ici</Link></p>
                        <p className="textDocSortouch">Intégrer son chatbot à son site ReactJs <Link style={{color: "rgb(46, 46, 46)"}} to="/installer-react">ici</Link></p>
                    </div>
                </div>
                <div className="contentDocSortouch">
                    <h4 className="titleStepDoc">Consultez les prises de contact avec vous via votre chatbot</h4>
                    {window.innerWidth > 1280 && <p className="numberStepDoc">5</p>}
                    <div className="onContentDoc">
                ...
                <div className="contentDocSortouch">
                    ...
                    {window.innerWidth > 1280 && <p className="numberStepDoc">6</p>}
                    <div className="onContentDoc">
