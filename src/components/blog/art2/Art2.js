...
const Art2 = () => {
    ...
    const shemaOrg = {
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://sortouch.co/chatbot-explication-simple"
        },
        "headline": "Comprendre rapidement ce qu’est un chatbot et à quoi ça sert",
        "description": `Vous avez aperçu ou entendu le mot “chatbot” et ça a suffi pour titiller votre curiosité ?
        Vous souhaitez en savoir plus ? Je vais vous aider !
        Une explication simple pour un sujet simple.`,
        "image": "https://sortouch.co/static/media/chatbot.82731f55.png",
        "author": {
            "@type": "Person",
            "name": "Thomas Dryjard"
        },
